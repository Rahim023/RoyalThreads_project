          ...
          {wishlist.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-md overflow-hidden border border-gray-200 hover:border-brand-gold transition-all"
              >
                {/* IMAGE */}
                ...
                <div className="p-5 text-center">
                  ...
                  {/* ⭐ FIXED — shows correct currency & converted price */}
