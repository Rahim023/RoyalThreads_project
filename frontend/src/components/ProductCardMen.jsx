  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4">
          <h3 className="text-lg font-heading font-semibold text-gray-900">{product.title}</h3>
          {!minimal && (
      ...
      {showModal && (
        ...
        >
          ...
          >
            ...
            />
            <h2 className="text-2xl font-heading font-bold text-gray-900 mb-2">{product.title}</h2>
            <p className="text-gray-700 mb-2 font-body">{product.description}</p>
            <p className="text-gray-500 mb-2 font-body">Category: {product.category}</p>
            <p className="text-gray-500 mb-2 font-body">Brand: {product.brand}</p>
            <p className="text-gray-500 mb-2 font-body">Stock: {product.stock}</p>
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-gray-600 font-body">{product.rating}/5</span>
            </div>
